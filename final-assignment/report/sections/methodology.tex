...
\label{sec:methodology}
    ...
    \subsection{Sampling Method}
        ...
        The way in which they use GitHub is different from most other projects, but they do have a lot of stars, partly due to brand awareness; \todo{reference} therefore, they are not included in our sample.
