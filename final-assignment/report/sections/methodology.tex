\section{Methodology}
    ...
    To be able to find out whether this has influence on the amount of stars a project can possibly get, a couple of features are created to be included in the prediction model.
    \begin{LaTeXdescription}
