\section{Results}
    \subsection{Data Exploration}
    	...
    	There are two elements in this plot that might attract your attention: most of the projects have a percentage of 0 accepted pull request, and there is an increase at 1 (or 100\%). 
...
%	    \begin{figure}[t!]
    ...
    Another notable aspect is that the average followers per organization and maximum followers per organization - and the same applies to average followers and maximum followers of contributors - were strongly correlated. 
    ...
    \subsection{Testing the model}
        ...
        Based on the exploration, it was decided to drop three variables: the maximum number of followers per organization, the average\\\\number of followers per contributor and the pull request acceptance ratio.
        ...
        \end{center}
        \footnotetext[1]{Implementation can be found at \url{https://cran.r-project.org/web/packages/pls/index.html}.}
        \footnotetext[3]{Standard R\cite{r-project-2016} implementation is used.}
        \footnotetext[4]{Implementation can be found at \url{https://cran.r-project.org/web/packages/nnet/index.html}.}
        \footnotetext[5]{Implementation can be found at \url{https://cran.r-project.org/web/packages/randomForest/index.html}.}
        \footnotetext[6]{In order to make this algorithm work, the country of origin feature was removed, as the implementation that was used was not able to handle a categorical variable with such a large number of possible values.}
