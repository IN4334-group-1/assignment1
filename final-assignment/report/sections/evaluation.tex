\section{Evaluation}
\todo{Todo: Describe this better: \\
Data has been evaluated, since random samples were taken to be checked on GitHub to see if the found data corresponds with the actual data. Also outliers where double checked to make sure they are right and not some anomalies in the data.}
