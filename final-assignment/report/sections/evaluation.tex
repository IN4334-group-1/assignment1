...
\todo{In order to minimize the influence of subjectiveness, projects where checked and classified by more than one person when it was not clear in which domain it should belong.}\\
...
This means that if a project was listed as having a certain amount of commits in GHTorrent, it should at least have this amount of commits on GitHub \todo{as commits are very rarely deleted}. \\
